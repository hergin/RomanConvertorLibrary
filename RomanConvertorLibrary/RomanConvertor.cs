...
namespace RomanConvertorLibrary
{
    ...
    public class RomanConvertor
	{
		...
		{
            Dictionary<char, int> CharValues = null;
            if (CharValues == null)
            {
		...
		{
            if ((number < 0) || (number > 3999)) throw new InvalidOperationException("insert value betwheen 1 and 3999");
            ...
            if (number == 0) throw new InvalidOperationException("bad");
